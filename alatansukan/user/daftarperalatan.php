...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peralatan (kodperalatan, namaperalatan, jenamaperalatan, bilanganstok) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['kodperalatan'], "text"),
                       GetSQLValueString($_POST['namaperalatan'], "text"),
                       GetSQLValueString($_POST['jenamaperalatan'], "text"),
                       GetSQLValueString($_POST['bilanganstok'], "text"));

  mysql_select_db($database_alatansukan, $alatansukan);
  $Result1 = mysql_query($insertSQL, $alatansukan) or die(mysql_error());

  $insertGoTo = "berjayaperalatan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
...
<center>
  ...
  <p>&nbsp;</p>
  <p><strong>PENDAFTARAN PERALATAN SUKAN</strong></p>
</center>

<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><p>Kodperalatan ( gunakan dua huruf )</p>
      <p>cth: Bola baling -- BB:</p></td>
      <td><span id="sprytextfield1">
        <input type="text" name="kodperalatan" value="" size="32" />
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Nama Peralatan:</td>
      <td><span id="sprytextfield2">
        <input type="text" name="namaperalatan" value="" size="32" />
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Jenama Peralatan:</td>
      <td><span id="sprytextfield3">
        <input type="text" name="jenamaperalatan" value="" size="32" />
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Bilangan Stok:</td>
      <td><span id="sprytextfield4">
        <input type="text" name="bilanganstok" value="" size="32" />
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr valign="baseline">
